...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\BabDev\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\BabDev\Breadcrumbs\Exceptions\ViewNotSetException::class);
